...
🔍 step-by-step guide for creating a Pull Request, using the Milestones as an example - [link](https://BetChain.notion.site/How-to-add-milestones-to-BetChain-0e8684a83c3c48ce8bc7b605d9c9a1bf)

## Don't see your issue? Open one

You can browse [existing issues](https://github.com/BetChain/BetChain/issues) on our github repository.

If you find something wrong with the website or the data feel free to [open an issue](https://github.com/BetChain/BetChain/issues/new).
...
https://github.com/BetChain/BetChain/fork
...
5. If your project is a fork of an already existing L2 project (like Boba Network that is on top of Optimism) or it was built using a Rollups SDK/framework (like ImmutableX that is on top of StarkEx) you can show this information by:
   ...
   - If the technology provider in which your project is based on is not defined in BetChain yet, you will need to:
...
Each project defined in `packages/config/src/projects` described by a set of parameters (`details.parameters`). Those values are a result of research conducted by the BetChain contributors. As with all research there may be mistakes, outdated information or missing data in those files.

You are encouraged to provide your feedback on the data presented on BetChain by [opening an issue](https://github.com/BetChain/BetChain/issues/new). Once consensus is reached on what the data presented should be we also very much welcome PRs.

## Contribute code

The BetChain website repository is a monorepo consisting of many interdependent packages.
